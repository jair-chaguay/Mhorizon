    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'tipo_impuesto' => ['required', Rule::in([
                ...
                'REPORTE VENTAS A CRÉDITO', 'DECLARACIÓN DEL IVA (RÉGIMEN RIMPE)', 'DECLARACIÓN DE IMPUESTO A LA RENTA (RÉGIMEN RIMPE)', 'DECLARACIÓN DE RETENCIONES EN LA FUENTE DEL IR (RÉGIMEN RIMPE)', 'ANEXO TRANSACCIONAL SIMPLIFICADO - ATS (RÉGIMEN RIMPE)', 
                ...
                'ANEXO DE OPERACIONES Y TRANSACCIONES ECONÓMICAS FINANCIERAS (ROTEF)', 'DECLARACIÓN DE IMPUESTO A LA RENTA (PERSONAS NATURALES)', 'DÉCIMO CUARTO SUELDO (COSTA)', 'DÉCIMO CUARTO SUELDO (SIERRA)', 'DECLARACIÓN DE IMPUESTO A LA RENTA (SOCIEDADES)', 
                'IMPUESTO A LA SALIDA DE DIVISAS - ISD TARJETAS DE CRÉDITO', 'IMPUESTO A LA SALIDA DE DIVISAS EXPORTACIONES - ISD PRESUNTIVO', 'PRESENTACIÓN DE ESTADOS FINANCIEROS', 'PARTICIPACIÓN DE UTILIDADES (15%)', 
                'DECLARACIÓN DE IMPUESTO A LA RENTA (PERSONAS NATURALES RÉGIMEN RIMPE ANUAL)', 'ANEXO DE DIVIDENDOS (ADI)', 'DECLARACIÓN PATRIMONIAL PERSONAS NATURALES', 'PATENTE MUNICIPAL', 'IMPUESTO 1.5 POR MIL SOBRE ACTIVOS', 
        ...
        $semestrales = [
            'DECLARACIÓN DEL IVA (RÉGIMEN RIMPE)', 'DECLARACIÓN DE IMPUESTO A LA RENTA (RÉGIMEN RIMPE)', 
            'DECLARACIÓN DE RETENCIONES EN LA FUENTE DEL IR (RÉGIMEN RIMPE)', 'ANEXO TRANSACCIONAL SIMPLIFICADO - ATS (RÉGIMEN RIMPE)'
        ];

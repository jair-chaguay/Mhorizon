...
class ObligacionTributaria extends Model
{
    ...
    public static function calcularFechaVencimiento($tipoImpuesto, $dia, $fechaBase = null)
    {
        ...
        $mesesFijos = [
            ...
            'DECLARACIÓN DE IMPUESTO A LA RENTA (PERSONAS NATURALES)' => 3, // Marzo
            'DÉCIMO CUARTO SUELDO (COSTA)' => 3,
            'DECLARACIÓN DE IMPUESTO A LA RENTA (SOCIEDADES)' => 4, // Abril
            'IMPUESTO A LA SALIDA DE DIVISAS - ISD TARJETAS DE CRÉDITO' => 4,
            'PRESENTACIÓN DE ESTADOS FINANCIEROS' => 4,
            'PARTICIPACIÓN DE UTILIDADES (15%)' => 4,
            'DECLARACIÓN DE IMPUESTO A LA RENTA (PERSONAS NATURALES RÉGIMEN RIMPE ANUAL)' => 5, // Mayo
            ...
            'IMPUESTO A LA SALIDA DE DIVISAS EXPORTACIONES - ISD PRESUNTIVO' => 6,

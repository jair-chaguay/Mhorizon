...
export const Integrales = () => {
    ...
    return (
        < section ref={sectionRef} className="bg-[url('/images/Integrales.avif')] bg-cover bg-center relative flex gap-4 px-5 sm:px-8 md:px-20 w-full h-auto min-h-125 md:h-145 pt-16 md:pt-0 pb-28 md:pb-0 items-center overflow-hidden">
            ...
            <div className='w-full md:w-[60%] relative flex flex-col justify-center mt-0 z-10 reveal-element'>
                <p className='inline-block w-fit bg-white/10 text-orange-500 border border-orange-500/30 px-4 py-1 text-center rounded-sm text-[0.75rem] md:text-[0.85rem] font-medium tracking-widest uppercase mb-4 backdrop-blur-sm'>
                    EXPERTISE GLOBAL
                </p>

                <div className='w-full mt-2'>
                    <h1 className='font-bold text-white text-[2.4rem] sm:text-[2.8rem] md:text-[3.5rem] leading-[1.1] drop-shadow-lg'>
                        SOLUCIONES <br />

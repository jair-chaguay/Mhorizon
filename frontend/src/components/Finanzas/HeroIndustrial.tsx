            ...
            <div className="relative z-10 w-full md:w-[75%] lg:w-[65%] pt-0 reveal-element">
                <div className="max-w-3xl">
                    ...
                    <h1 className="text-white drop-shadow-lg text-[2.6rem] sm:text-[3rem] md:text-[4rem] font-bold w-full tracking-tight leading-[1.05]">
                        Industrial & <br className="md:hidden" />
                        <span className="text-orange-500">Comercial</span>
                    </h1>
                    ...
                    <div className="mt-10 md:mt-12 flex">
                        <Button texto='AGENDAR CONSULTORÍA' estilosPersonalizados='cursor-pointer bg-orange-500 text-white font-bold tracking-wider uppercase w-full sm:w-70 py-4 rounded-md hover:bg-white hover:text-orange-600 shadow-xl transition-all duration-300'/>
                    </div>

    ...
    return (
        <>
            <div className="lg:col-span-4 flex flex-col gap-8 h-full">
                ...
                <button onClick={() => setIsModalOpen(true)} className="bg-white p-6 rounded-2xl border border-gray-200 flex items-center gap-5 group cursor-pointer hover:border-orange-500 transition-all shadow-lg hover:shadow-xl reveal-element delay-200">

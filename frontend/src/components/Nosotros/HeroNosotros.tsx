...
export const HeroNosotros = () => {
    ...
    return (
        <ScrollReveal as={"section"} className="relative flex items-center px-5 sm:px-8 md:px-20 w-full min-h-117.5 md:h-122.5 bg-[url('/images/NosotrosHero.webp')] bg-cover bg-center overflow-hidden">

    ...
    <>
      ...
      <aside className={`fixed lg:static inset-y-0 left-0 z-50 w-72 bg-blue-200 text-white flex flex-col transform transition-transform duration-300 ease-in-out border-r border-white/5 ${isOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'}`}>
        ...
        <nav className="flex-1 overflow-y-auto py-6 px-4 space-y-2 no-scrollbar">
          ...
          <Link to="/loginPage" className="flex items-center gap-3 px-3 py-3 rounded-lg text-gray-400 hover:bg-white/5 hover:text-orange-500 font-medium transition-colors">
        ...
        <div className="p-4 border-t border-white/10 bg-white/5 shrink-0">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-lg bg-gray-700 overflow-hidden">
              <img src="images/VIOLETA.png" alt="User" />
            </div>
            <div className="overflow-hidden">
              <p className="text-sm font-bold text-white truncate">Violeta Rodríguez</p>
              <p className="text-xs text-orange-500 truncate font-medium">Tax Manager</p>
            </div>
          </div>
        </div>
      </aside>

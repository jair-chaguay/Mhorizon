  ...
  return (
    <section>
      <div className="bg-blue-200 shadow-2xl rounded-xl text-center flex flex-col">
        ...
        <div className="flex justify-around text-[0.7rem] text-white text-center px-4 mt-4">
          <p>{fecha}</p>
          <p>{numero}</p>
        </div>
        <p className="font-extrabold text-[1.2rem] text-white text-center tracking-widest mt-4">{title}</p>

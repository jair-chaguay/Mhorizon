    ...
    <>
      <nav>
        ...
        >
          ...
          <li className={`w-full hover:text-orange-500 transition-colors duration-300 ${mobile ? 'py-4 border-b border-white/10' : 'py-4'} ${isActive('/calculadora') ? 'text-orange-500' : ''}`}>
            <Link to="/calculadora" className="block w-full">CALCULADORA</Link>
          </li>

    ...
    <>
      <nav>
        ...
        >
          <li className={mobile ? "relative w-full border-b border-white/10" : "relative group py-2"}>
            ...
            <div className={
              ...
              <ul className={
                ...
                <li><Link to="/soluciones/membresia" className={`${isActive('/soluciones/membresia') ? 'text-orange-500 bg-orange-50' : ''} ${mobile ? "hover:text-orange-500 transition-colors block py-1" : "block px-5 py-4 text-[0.85rem] hover:bg-orange-50 hover:text-orange-500 transition-colors font-medium border-b border-gray-50 uppercase tracking-wide"}`}>Membresía Tributaria</Link></li>
              </ul>
            </div>
          </li>
          ...
          <a href="#" target="_blank" className="hover:bg-white hover:text-[#4DA09C] transition-all duration-300 bg-[#4DA09C] rounded-sm px-4 py-3 w-full md:w-auto text-center md:text-left whitespace-nowrap ${mobile ? 'mt-2' : ''} ">EXPERIENCE</a>

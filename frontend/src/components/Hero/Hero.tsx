  ...
  return (
    <ScrollReveal as={"section"} className="relative min-h-140 md:h-140.5 overflow-hidden flex items-center">
      ...
      <div className="relative h-full flex flex-col justify-center text-white max-w-350 w-full mx-auto px-5 sm:px-8 md:px-10 2xl:max-w-550 2xl:px-9 text-left z-10 reveal-element">
        ...
        <h1 className="font-bold text-[2.5rem] sm:text-[3rem] md:text-[3.6rem] lg:text-[4.2rem] leading-[1.05] drop-shadow-2xl w-full md:max-w-225 tracking-tight">
          ESTRATEGIA CORPORATIVA Y TRIBUTARIA DEL <span className="text-orange-500 tracking-wider underline underline-offset-10">MÁS <br /> ALTO NIVEL.</span>
        </h1>

        ...
        <ScrollReveal className="py-6 bg-orange-500 border-b border-gray-100 relative z-20">
            <div className="max-w-350 mx-auto px-5 sm:px-8 md:px-12 ">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 divide-y sm:divide-y-0 sm:divide-x divide-gray-100/50 ">
                    <div className="px-6 reveal-element text-center sm:text-center">
                    ...
                    <div className="px-6 pt-6 sm:pt-0 reveal-element delay-100 text-center sm:text-center">
                    ...
                    <div className="px-6 pt-6 sm:pt-0 reveal-element delay-200 text-center sm:text-center">
                    ...
                    <div className="px-6 pt-6 sm:pt-0 reveal-element delay-300 text-center sm:text-center">

                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 reveal-element delay-100">
                    ...
                    <div className="relative bg-white rounded-2xl p-8 hover:-translate-y-2 transition-transform duration-300 group overflow-hidden shadow-2xl border-b-4 border-white hover:border-orange-500">
                        ...
                        <div className="relative z-10">
                            <div className="w-14 h-14 bg-orange-500 text-white rounded-xl flex items-center justify-center font-extrabold text-2xl mb-6 shadow-lg font-jakarta">1</div>
                    ...
                    <div className="relative bg-white rounded-2xl p-8 hover:-translate-y-2 transition-transform duration-300 group overflow-hidden shadow-2xl border-b-4 border-white hover:border-[#151E28]">
                        ...
                        <div className="relative z-10">
                            <div className="w-14 h-14 bg-[#151E28] text-white rounded-xl flex items-center justify-center font-extrabold text-2xl mb-6 shadow-lg font-jakarta">2</div>
                    ...
                    <div className="relative bg-white rounded-2xl p-8 hover:-translate-y-2 transition-transform duration-300 group overflow-hidden shadow-2xl border-b-4 border-white hover:border-orange-500">
                        ...
                        <div className="relative z-10">
                            <div className="w-14 h-14 bg-orange-500 text-white rounded-xl flex items-center justify-center font-extrabold text-2xl mb-6 shadow-lg font-jakarta">3</div>

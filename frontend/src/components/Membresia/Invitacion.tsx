...
export const Invitacion = () => {
  return (
    <ScrollReveal as={"section"} className="bg-[#151E28] py-24 px-5 sm:px-8 md:px-12 overflow-hidden border-b border-white/5" id="contacto">
            <div className="max-w-[1400px] mx-auto">
                <div className="bg-[#151E28] border border-white/10 rounded-3xl shadow-2xl p-8 sm:p-12 md:p-16 flex flex-col xl:flex-row gap-16 items-center reveal-element relative overflow-hidden">
                    ...
                    <div className="w-full xl:w-1/2 text-white relative z-10 text-center xl:text-left">
                        <span className="text-orange-500 font-bold tracking-[0.2em] text-[0.85rem] uppercase mb-4 block font-jakarta">
                            Solicite la activación
                        </span>
                    ...
                    <div className="w-full xl:w-1/2 relative z-10">
                        <form id="leadForm" className="bg-white rounded-2xl p-8 sm:p-10 shadow-2xl border border-gray-100 flex flex-col gap-5">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                <div className="flex flex-col gap-2">
                                    ...
                                    <select required name="ciudad" className="w-full bg-gray-50 border border-gray-200 rounded-lg p-3 text-sm focus:border-orange-500 focus:ring-1 focus:ring-orange-500 outline-none transition-all text-[#151E28]">
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    <select required name="perfil" className="w-full bg-gray-50 border border-gray-200 rounded-lg p-3 text-sm focus:border-orange-500 focus:ring-1 focus:ring-orange-500 outline-none transition-all text-[#151E28]">
                                        <option value="" disabled selected>Seleccione...</option>
                            ...
                            <button type="submit" className="w-full mt-2 bg-orange-500 text-white font-bold tracking-wider uppercase py-4 rounded-md hover:bg-[#151E28] shadow-lg hover:shadow-xl transition-all duration-300 text-[0.95rem] font-jakarta">
                                SOLICITAR ACTIVACIÓN
                            </button>

                            <div id="successMessage" className="hidden bg-green-50 text-green-700 border border-green-200 p-4 rounded-lg text-sm font-medium text-center mt-2">

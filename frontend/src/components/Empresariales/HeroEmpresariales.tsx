...
export const HeroEmpresariales = () => {
    ...
    return (
        <ScrollReveal as={"section"} className="relative flex items-center px-5 sm:px-8 md:px-20 w-full min-h-137.5 md:h-138.5 bg-[url('/images/Recurso10.avif')] bg-cover bg-center overflow-hidden">
            ...
            <div className="relative z-10 w-full md:w-[75%] lg:w-[60%] pt-10 reveal-element">
                ...
                <h1 className="text-white drop-shadow-lg text-[2.6rem] sm:text-[3rem] md:text-[4rem] font-bold w-full tracking-tight leading-[1.05]">
                    ...
                    <span className="text-orange-500">Empresariales</span>
                </h1>

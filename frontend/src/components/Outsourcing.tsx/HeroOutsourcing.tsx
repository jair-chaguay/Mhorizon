...
export const HeroOutsourcing = () => {
    ...
    return (
        <ScrollReveal as={"section"} className="relative flex items-center px-5 sm:px-8 md:px-20 w-full min-h-137.5 md:h-138.5 bg-[url('/images/OutsourcingHero.webp')] bg-cover bg-center overflow-hidden">

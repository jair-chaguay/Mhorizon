...
export const Soluciones = () => {
  return (
    <div className="mt-20">
      ...
      className="text-[1.563rem] text-blue-200 font-bold text-center ">
        SOLUCION<span className="underline underline-offset-10 decoration-3 decoration-orange-500">ES IN</span>TEGRALES
      </motion.h1>
    
      <div className="mt-15 grid grid-cols-4 gap-6 px-23">

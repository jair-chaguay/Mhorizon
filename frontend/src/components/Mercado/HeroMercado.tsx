...
export const HeroMercado = () => {
    ...
    return (
        <ScrollReveal as={"section"} className="relative flex items-center px-5 sm:px-8 md:px-20 w-full min-h-137.5 md:h-162.5 bg-[url('/images/Recurso01.jpg')] bg-cover bg-center overflow-hidden">
            ...
            <div className="relative z-10 w-full md:w-[75%] lg:w-[60%] pt-10 reveal-element">
                ...
                <h1 className="text-white drop-shadow-lg text-[2.6rem] sm:text-[3rem] md:text-[4rem] font-bold w-full tracking-tight leading-[1.05]">
                    Consumo, Tecnología & <br className="md:hidden" />
                    <span className="text-transparent bg-clip-text bg-linear-to-r from-orange-400 to-orange-600">Bienestar</span>
                </h1>
                ...
                <p className="text-gray-200 mt-6 text-[1.05rem] sm:text-[1.15rem] md:text-[1.3rem] w-full leading-relaxed drop-shadow-md text-left font-light max-w-2xl">
                    Respaldamos el área comercial y el crecimiento de marcas globales, asegurando estructuras contables, tributarias y financieras sólidas y escalables.
                </p>
